...
{
    public BoardTaskControllerTests(TestWebApplicationFactory factory) : base(factory)
    {
    }

    [Fact]
    public async Task GetBoardTaskById_WhenTaskExists_ReturnsTask()
    {
        // Arrange
        ...
        // Act
        var response = await client.GetAsync("/api/boards/1/tasks/1");
    ...
    [Fact]
    public async Task GetBoardTaskById_WhenTaskDoesNotExist_ReturnsNotFound()
    {
        // Arrange
        var user = new ApplicationUser
        {
