...
public class CustomWebApplicationFactory : WebApplicationFactory<Program>
{
    ...
    {
        // Set env vars before Program.cs runs so TryGetConfigValue doesn't call Environment.Exit(1)
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        {
            // Swap PostgreSQL for SQLite using the shared in-memory connection
            ...
            // Replace email service (including Scrutor-generated decorator) with no-op
            ...
            // Replace IFileService with no-op for upload tests
